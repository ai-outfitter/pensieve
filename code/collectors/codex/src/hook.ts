 ...
 * rather than `tool_output`. Normalizing here, and sharing everything else, is
 * what keeps the emitted records identical across harnesses. CLC-001.1.5.
 *
 * Like Claude Code, Codex hooks never carry the model request or response body,
 * so this collector declares `model-exchange` unsupported. CLC-001.7.2.
 */
